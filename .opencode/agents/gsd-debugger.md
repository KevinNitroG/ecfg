...
Check code says:  hooksDir = path.join(configDir, 'hooks')
                  ...
                  → checks /home/kevinnitro/projects/ecfg/.opencode/hooks/

Installer says:   hooksDest = path.join(targetDir, 'hooks')
                  targetDir = /home/kevinnitro/projects/ecfg/.opencode/get-shit-done
                  → writes to /home/kevinnitro/projects/ecfg/.opencode/get-shit-done/hooks/
...
```bash
INIT=$(node "/home/kevinnitro/projects/ecfg/.opencode/get-shit-done/bin/gsd-tools.cjs" state load)
...
```bash
node "/home/kevinnitro/projects/ecfg/.opencode/get-shit-done/bin/gsd-tools.cjs" commit "docs: resolve debug {slug}" --files .planning/debug/resolved/{slug}.md
```
...
```bash
node "/home/kevinnitro/projects/ecfg/.opencode/get-shit-done/bin/gsd-tools.cjs" commit "docs: update debug knowledge base with {slug}" --files .planning/debug/knowledge-base.md
```
