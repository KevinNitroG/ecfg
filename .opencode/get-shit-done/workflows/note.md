...
- **Global scope**: `/home/kevinnitro/projects/ecfg/.opencode/notes/{YYYY-MM-DD}-{slug}.md` — fallback when no `.planning/`, or when `--global` flag is present
...
2. Ensure the notes directory exists (`.planning/notes/` or `/home/kevinnitro/projects/ecfg/.opencode/notes/`)
...
2. Glob `/home/kevinnitro/projects/ecfg/.opencode/notes/*.md` (if directory exists) — global notes
...
Global (/home/kevinnitro/projects/ecfg/.opencode/notes/):
...
2. **No `.planning/`**: Falls back to global `/home/kevinnitro/projects/ecfg/.opencode/notes/` — works in any directory
